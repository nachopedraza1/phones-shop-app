...
import { Container, Grid, TextField, Typography, Button, Divider, AppBar, IconButton, Link as MuiLink } from '@mui/material';
        ...
        <Grid container bgcolor='#f9f9f9' paddingTop={1} paddingBottom={1} position='relative'>
          <Container maxWidth='xl'>
            <Grid container gap={4}>
              <MuiLink component={Link} href='/' fontWeight={600} underline="none" onMouseEnter={() => handleOpenMega('iPhones')}>
                iPhones
              </MuiLink>
              <MuiLink component={Link} href='/' fontWeight={600} underline="none">
                iPads
              </MuiLink>
              <MuiLink component={Link} href='/' fontWeight={600} underline="none">
                MacBooks
          ...
          <Grid container className={`megamenu ${openMegamenu && 'open-mega'}`} onMouseLeave={() => setOpenMegamenu(false)}>
            {
